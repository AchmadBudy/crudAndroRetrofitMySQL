...
import com.example.mahasiswa.Adapter.AdapterData;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void keUbahData(int idL){
        String value=String.valueOf(idL);
        Intent i = new Intent(MainActivity.this, UbahActivity.class);
